      ...
      <nav className="fixed top-0 left-0 right-0 bg-[#432721] text-[#F1E4A6] px-6 py-4 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-6">
            ...
            <Link href="/products" className="py-2 px-3 hover:text-[#61B785] transition-colors duration-300">
              Produtos
            </Link>
        ...
        <div
          className={`fixed top-0 right-0 h-full w-64 bg-[#432721] text-[#F1E4A6] z-50 transform ${
        ...
        >
          <div className="flex flex-col items-start p-4 space-y-4">
            ...
            <Link href="/products" className="py-2 hover:text-[#61B785] transition-colors duration-300" onClick={toggleMenu}>
              Produtos
            </Link>
